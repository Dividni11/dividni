...
app.config['MAIL_USERNAME'] = 'dividni11@gmail.com'
app.config['MAIL_PASSWORD'] = 'qtij qbti bjnj qmpw'
app.config['MAIL_DEFAULT_SENDER'] = 'dividni11@gmail.com' # Для отладки
